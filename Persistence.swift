...
struct PersistenceController {
    ...
    init(inMemory: Bool = false) {
        container = NSCustomPersistentContainer(name: "Rollerblade")
...
class NSCustomPersistentContainer: NSPersistentCloudKitContainer {
    ...
    override open class func defaultDirectoryURL() -> URL {
        var storeURL = FileManager.default.containerURL(forSecurityApplicationGroupIdentifier: "group.BenjaminWho.aqua")
        storeURL = storeURL?.appendingPathComponent("Rollerblade.sqlite")
        return storeURL!
    }
